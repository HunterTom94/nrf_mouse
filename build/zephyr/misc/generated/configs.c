...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_LIM_ADV_TIMEOUT, 180);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_MAX_INT, 18);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_PERIPHERAL_PREF_LATENCY, 10);
